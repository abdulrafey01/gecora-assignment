  ...
  return (
    <div className="flex-1 flex flex-col py-5 px-10">
      ...
      <div className="flex flex-col gap-6 mt-10">
        <SideBarLink
          icon={() => (
            <Image className="w-8 h-7" src={IphoneIcon} alt="Iphone" />
          )}
          text={"iPhone"}
        ...
        <SideBarLink
          icon={() => (
            <Image
              width={1000}
              height={1000}
              className="w-[12px] h-[23px] ml-2 mr-3"
              src={AirPodIcon}
              alt="Iphone"
            />
          )}
        ...
        <SideBarLink
          icon={() => (
            <Image className="w-[32px] h-[34px]" src={WatchIcon} alt="Watch" />
          )}
          text={"SmartHome"}
          textFont={"font-semibold"}
          blackVariant={true}
        ...
        <SideBarLink
          icon={() => (
            <Image className="w-[29px] h-[29x]" src={CableIcon} alt="Watch" />
          )}
          text={"Príslušenstvo"}
          textFont={"font-semibold"}
          blackVariant={true}
        ...
        <SideBarLink
          icon={() => (
            <Image className="w-[32px] h-[32px]" src={Smarthome} alt="Watch" />
          )}
          text={"Smarthome"}
          textFont={"font-semibold"}
          blackVariant={true}
        ...
        <SideBarLink
          icon={() => (
            <Image
              className="w-[23px] h-[27px] ml-1 mr-2"
              src={PCIcon}
              alt="PC"
            />
          )}
